namespace JogoDaForcaDefinitive.ConsoleApp
{
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                do
                {
                    ...
                    {
                        Console.WriteLine("*------------------------------*--------------------------------*");
                        Console.WriteLine($" Bom trabalho! Você desvendou a palavra sorteada: {palavraEscolhida}");
                        Console.WriteLine("*------------------------------*--------------------------------*");
                    }
                    else if (jogadorEnforcou)
                    {
                        Console.WriteLine("*------------------------------*--------------------------------*");
                        Console.WriteLine("         Ops! Não foi dessa vez... Tente novamente!");
                        Console.WriteLine("*------------------------------*--------------------------------*");
                    }
